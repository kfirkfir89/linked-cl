...
import InstructionsCard from '../instructions-card/instructionsCard.component';
    ...
    <div className='flex items-center self-center flex-col container md:px-16 px-2 mb-14'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-5 w-full text-slate-600 text-center font-semibold tracking-tight'>
        <InstructionsCard>
          ...
          Simply upload your resume. Our AI starts here, analyzing your professional history to understand your skills, achievements, and career goals.
        </InstructionsCard>
